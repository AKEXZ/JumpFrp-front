                            ...
                            <transition name="text-fade" mode="out-in">
                                <div :key="mode">
                                    <template v-if="mode === 'login'">
                                        <h1>Sign In to<br />JumpFrp Panel</h1>
                                        <p>
                                            如果您还没有账号<br />请
                                    ...
                                    <template v-else-if="mode === 'register'">
                                        <h1>Sign Up to<br />JumpFrp Panel</h1>
                                        <p>
                                            已经有账号了?<br />请
                                            <n-button text type="primary" @click="toggleRegister">点击这里</n-button>
                                            进行登录.
                                    ...
                                    <template v-else>
                                        <h1>Reset Your PW<br />JumpFrp Panel</h1>
                                        <p>
                                            想起密码了?<br />请
                                    ...
                                    <n-form ref="resetFormRef" :model="resetModel" :rules="resetRules">
                                        ...
                                        <n-form-item label="验证码" path="verificationCode">
                                            <n-grid x-gap="12" :cols="5">
                                                <n-gi :span="3">
                                                    <n-input
                                                        v-model:value="resetModel.verificationCode"
                                                        size="large"
                                                        round
                                                        placeholder="验证码"
                                                        maxlength="6"
